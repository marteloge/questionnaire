...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('questionnaire', '0011_auto_20150209_1212'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='person',
            name='experience',
            field=models.CharField(default=0, max_length=1, choices=[(b'0', b'default'), (b'Y', b'Yes'), (b'N', b'No')]),
        ...
        migrations.AlterField(
            model_name='person',
            name='gender',
            field=models.CharField(default=0, max_length=1, choices=[(b'0', b'default'), (b'M', b'Male'), (b'F', b'Female')]),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='person',
        ...
        migrations.AlterField(
            model_name='person',
            name='screenlock',
            field=models.CharField(default=0, max_length=20, choices=[(b'0', b'default'), (b'pattern', b'pattern'), (b'fingerprint', b'fingerprint'), (b'PIN', b'PIN'), (b'slide', b'slide'), (b'other', b'other'), (b'password', b'password')]),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='person',
